---
title: "Changelog"
description: "Etapsky product changelog — all releases across sdf-kit, sdf-cli, sdf-server-core, sdf-schema-registry, Python SDK, and Cloud SDK."
sidebar:
  label: "Changelog"
  order: 0
---

All releases across the Etapsky ecosystem. Follows [Semantic Versioning](https://semver.org). Packages are published to [npm](https://www.npmjs.com/org/etapsky) and [PyPI](https://pypi.org/project/etapsky-sdf/). CLI binaries are on [GitHub Releases](https://github.com/etapsky/sdf/releases).
...
**Released:** March 2026 &nbsp;·&nbsp; [`npm`](https://www.npmjs.com/package/@etapsky/sdf-cli) &nbsp;·&nbsp; [Homebrew](https://github.com/etapsky/homebrew-tap) &nbsp;·&nbsp; [GitHub Releases](https://github.com/etapsky/sdf/releases)
...
- macOS arm64 and x64 binaries on [GitHub Releases](https://github.com/etapsky/sdf/releases)
- Linux x64 and arm64 binaries on [GitHub Releases](https://github.com/etapsky/sdf/releases)
...
**Released:** March 2026 &nbsp;·&nbsp; [`npm`](https://www.npmjs.com/package/@etapsky/sdf-server-core)
...
**Released:** March 2026 &nbsp;·&nbsp; [`npm`](https://www.npmjs.com/package/@etapsky/sdf-schema-registry)
...
**Released:** March 2026 &nbsp;·&nbsp; [`npm`](https://www.npmjs.com/package/@etapsky/sdf-kit)
...
**Released:** March 2026 &nbsp;·&nbsp; [`PyPI`](https://pypi.org/project/etapsky-sdf/)
...
:::note
While packages are below `1.0.0`, minor version bumps may include breaking changes. Each package's changelog section will clearly mark any breaking change regardless of version number.
:::
...
- **GitHub**: [Watch releases](https://github.com/etapsky/sdf) on the `etapsky/sdf` repository
- **npm**: `npm info @etapsky/sdf-kit dist-tags`
- **PyPI**: [etapsky-sdf release history](https://pypi.org/project/etapsky-sdf/#history)
